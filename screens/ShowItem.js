 ...
 //   console.log('deleted',deleted);
    ...
    useEffect(() => {
        if (thisitem) {
            ...
            setCategory_id(thisitem.category_id);
    ...
    const updateItemInfo = async () => {
        try {
            ...
            setCategory_id(itemFromDb.category_id);
    ...
    const saveItem = async () => {
        ...
        try {
            ...
            /* kokeillaan saada tää ehkä myöhemmin toimimaan
            const updatedItem = { ...thisitem, timestamp: aikaleima };

             <SaveItemFrontend
                 item={updatedItem}
                 onResult={(success) => {
                     if (success) console.log('Save succeeded!');
        ...
        return (
            ...
            >
                <View style={styles.container}>
                    ...
                    <Text style={styles.text}>Timestamp: {thisitem.timestamp}</Text>
                    <Text style={styles.text}>Deleted: {thisitem.deleted}</Text>
